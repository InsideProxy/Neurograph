...
const nodeA: GraphNode = { id: "a", label: "A", abbreviation: "A", hemisphere: "L", network: "memory", position3d: [0, 0, 0] };
const nodeB: GraphNode = { id: "b", label: "B", abbreviation: "B", hemisphere: "R", network: "language", position3d: [1, 0, 0] };
