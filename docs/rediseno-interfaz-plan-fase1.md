...
- **Engranaje:** abre el panel, que muestra los cuatro temas con el activo marcado. Escape lo cierra y el foco vuelve al engranaje. Al salir del panel con Tab, se cierra. Con datos reales, abre el panel también con la ventana a 1280 px y a 1024 px de ancho: el panel tiene que verse entero, sin salirse de la pantalla.
