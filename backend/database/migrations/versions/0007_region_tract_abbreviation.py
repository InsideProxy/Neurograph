...
tienen valor todavía -- se rellenan con `scripts/backfill_region_and_tract_abbreviations.py`,
no con esta migración (una migración de esquema no debe además calcular
datos derivados de archivos externos).
